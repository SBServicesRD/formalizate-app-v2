...
export const TESTIMONIALS = [
    { 
        ...
        text: "Excelente servicio. Me ahorraron días de filas en la Cámara de Comercio. Todo el proceso fue muy transparente.", 
        rating: 5, 
        date: "Hace 2 días" 
    },
    { 
        id: 2,
        name: "Ana Martínez", 
        text: "La plataforma es súper intuitiva. En menos de 15 días ya tenía mi RNC y pude empezar a facturar de inmediato.", 
        rating: 5, 
        date: "Hace 1 semana" 
    },
    { 
        id: 3,
        name: "Javier Díaz", 
        text: "Muy profesionales. Resolvieron todas mis dudas fiscales al instante. 100% recomendados para cualquier emprendedor.", 
        rating: 5, 
        date: "Hace 3 semanas" 
    },
    { 
        id: 4,
        name: "Luisa Pérez", 
        text: "Me encantó que no tuve que ir a ninguna oficina. Todo fue digital y me enviaron los documentos finales por mensajería.", 
        rating: 5, 
        date: "Hace 1 mes" 
    },
    { 
        id: 5,
        name: "Miguel Ángel", 
        text: "El soporte por WhatsApp es muy rápido. Me ayudaron a elegir el nombre correcto para que ONAPI no lo rechazara.", 
        rating: 5, 
        date: "Hace 2 meses" 
    }
];